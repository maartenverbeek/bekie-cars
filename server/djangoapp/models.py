...
class CarMake(models.Model):
    name = models.CharField(null=False, max_length=30, default='Seat')
    description = models.CharField(null=False, max_length=300, default='Spanish delight')
...
class CarModel(models.Model):
    ...
    name = models.CharField(null=False, max_length=30, default='Seat Leon')
